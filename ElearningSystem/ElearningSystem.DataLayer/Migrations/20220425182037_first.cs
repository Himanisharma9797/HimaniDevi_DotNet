...
namespace ElearningSystem.DataLayer.Migrations
{
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FacultyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FacultyFirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FacultyLastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_facultyModels", x => x.FacultyId);
                });
